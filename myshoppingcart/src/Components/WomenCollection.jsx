...
function WomenCollection(props) {
    const{title,image1,image2,image3,image4,image5,image6,image7,image8,image9,image10,
        price1,price2,price3,price4,price5,price6,price7,price8,price9,price10  }=props.womenFashion
      return (
        <div className='colletion-section'>
            <div className='bannerBox'>
        <img src="assets/images/smallbanner1.jpg" alt="banner"/>
      </div> 
         <h2>{title}</h2>
         ...
         <div className='bannerBox'>
        <img src="assets/images/smallbanner2.jpg" alt="banner"/>
      </div> 
        </div>
  )
}
